...
Imports sdkLocalDatabaseVB.LocalDatabaseSample.ViewModel

    Partial Public Class App
        Inherits Application
        ' The static ViewModel, to be used across the application.
    Private Shared _viewModel As ToDoViewModel
    Public Shared ReadOnly Property ViewModel() As ToDoViewModel
        Get
            Return _viewModel
        End Get
    End Property
    ...
    Public Sub New()
        ...
        Dim DBConnectionString As String = "Data Source=isostore:/ToDo.sdf"

        ' Create the database if it does not exist.
        Using db As New ToDoDataContext(DBConnectionString)
            If db.DatabaseExists() = False Then
                ' Create the local database.
                db.CreateDatabase()

                ' Prepopulate the categories.
                db.Categories.InsertOnSubmit(New ToDoCategory With {.Name = "Home"})
                db.Categories.InsertOnSubmit(New ToDoCategory With {.Name = "Work"})
                db.Categories.InsertOnSubmit(New ToDoCategory With {.Name = "Hobbies"})
        ...
        _viewModel = New ToDoViewModel(DBConnectionString)
